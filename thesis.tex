...
% (unofficial fork  KULeuven Brugge (new naming without Campus)        %
% Made by Felix D'Hoore                                                %
% 15/10/2023 v1.3                                                      %
%                                                                      %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\afdeling{afstudeerrichting Smart Electronics and ICT}

\campus{brugeseng} %denayer,denayereng,geel,geeleng,gent,ghenteng,groept,groupteng,brugge,brugeseng
...
%\includepdf{private/back_fiiw_brugge_eng.pdf} % For the english version
